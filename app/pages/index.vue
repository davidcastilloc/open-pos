      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center">
            <h1 class="text-2xl font-bold text-gray-900">POS Venezuela</h1>
            <span class="ml-2 text-sm text-gray-500">v{{ appVersion }}</span>
          </div>
          <div class="flex items-center space-x-4">
            <UBadge color="green">Sistema Activo</UBadge>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <UCard>
          <div class="flex items-center justify-between">
            <div>
              <h3 class="text-lg font-medium text-gray-900">Monedas</h3>
              <p class="text-sm text-gray-500">Tasas de cambio</p>
            </div>
            <div class="flex items-center">
              <UIcon 
        ...
        <UCard>
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-500">Sistema configurado</p>
            </div>
            <div class="flex items-center">
              <UIcon 
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <UCard class="cursor-pointer hover:shadow-md transition-shadow" @click="navigateTo('/pos')">
          <div class="text-center">
            ...
            <h3 class="text-lg font-medium text-gray-900">Punto de Venta</h3>
            <p class="text-sm text-gray-500">Iniciar venta</p>
          </div>
        </UCard>
        ...
        <UCard class="cursor-pointer hover:shadow-md transition-shadow" @click="navigateTo('/cash-closing')">
          <div class="text-center">
            ...
            <h3 class="text-lg font-medium text-gray-900">Cierre de Caja</h3>
            <p class="text-sm text-gray-500">Finalizar turno</p>
          </div>
        </UCard>
      </div>
      ...
      <UCard>
        <template #header>
          <div class="flex items-center justify-between">
            <h2 class="text-lg font-semibold">💱 Tasas de Cambio Actuales</h2>
            <UButton @click="refreshRates" :loading="currencyLoading" size="sm">

...
<script setup lang="ts">
	...
	const testDatabase = async () => {
		...
		try {
			...
			addResult("Consulta de tablas", true, `Se encontraron ${tables.rows.length} tablas`, tables);
	...
	const testCategories = async () => {
		...
		try {
			...
			addResult("Categorías", true, `Se encontraron ${categories.rows.length} categorías`, categories);
